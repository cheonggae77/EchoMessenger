...
## 실행 화면 (과제4)
	- 과제4 코드의 실행 스크린샷
![과제4 실행화면](img/과제4_1.png)
![과제4 실행화면](img/과제4_2.png)
![과제4 실행화면](img/과제4_3.png)
![과제4 실행화면](img/과제4_4.png)
![과제4 실행화면](img/과제4_5.png)
...
- 구현 내용과 기능 설명
1. btnDelete버튼을 새로 만들어 try함수로 예상외 변수를 차단하고 if함수를 통해 인덱스 선택을 하지 않았을 경우는 삭제할 메세지를 선택해달라는 메세지 박스를 출력하고 선택했을 경우 메세지를 삭제합니다.
2. btnAllDelete 버튼을 새로 만들어 리스트박스.item.clear() 메소드를 이용해 전체 삭제합니다.
3. 속성에서 글자수 제한을 50으로 설정한후 혹시 넘을 경우를 대비해 if함수를 활용하여 초과시 메세지 박스 출력후 다시 텍스트박스에 포커스가 가게 한후 함수를 마무리 합니다.
